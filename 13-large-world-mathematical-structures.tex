...
\begin{proofitem}
	...
	% f(a\circ a^{-1}) & = f(1) \\
	% & = 1    \\
	% f(a\circ a^{-1})                              & = f(a)\circ f(a^{-1}) \\
	% f(a)\circ f(a^{-1})                           & = 1                   \\
	% {(f(a)\right)}^{-1} \circ f(a)\circ f(a^{-1}) & {(f(a))}^{-1} \circ 1 \\
	% f(a^{-1})                                     & ={f(a)}^{-1}
	% \end{align*}
